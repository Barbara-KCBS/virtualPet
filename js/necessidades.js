...
const listaDeNecessidades = [humor, temperatura, sede, dinoFome, pesoEIdade, estudos];
    ...
    if(mostrarNecessidade === true){
        ...
        if(iniciarIntervaloNecessidades == true){
            ...
            var intervaloDaNecessidade = setInterval(() => {
                ...
                console.log("contador necessidades: " + contadorIntervaloNecessidade);
            }, 1000);
        }

        escNecessidades = true;
        contadorIntervaloNecessidade = 0;
        listaDeNecessidades[contadorNecessidades]();
    }
}

$(".selecao-esquerda").click(()=>{
    if(percorrerNecessidades === true){
...
$(".selecao-direita").click(() => {
    if(percorrerNecessidades === true){
        ...
        if(contadorNecessidades === 0){
            contadorNecessidades = 5;
        }
        else{
            contadorNecessidades -= 1;
        }
