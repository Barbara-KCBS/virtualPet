var mostrarLuzOn = false;

var mostrarLuzOff = false;

var mostrarPainelDeLuz = false;
var contadorIntervaloLuz = 0;
...
function luzOpcaoOn(){
    ...
    if(mostrarLuzOn === false){
        return
    }

    contadorIntervaloLuz = 0;
    mostrarLuzOff = true;
 ...
 function painelDeLuz(){
     if(mostrarPainelDeLuz === false){
         return
     }
         ...
         var intervaloLuz = setInterval(()=>{
            if(contadorIntervaloLuz === 10){
            ...
            contadorIntervaloLuz ++;
            console.log("intervalo luz: " + contadorIntervaloLuz);
         }, 1000)
     }
 }

function ligarLuz(){
    if(opcaoDeLuz === "luzOff" || opcaoDeLuz == null){
        return
    }

    contadorIntervaloLuz = 10;
    luzDesligada = false;
    console.log("enter ligar luz")
} 

function desligarLuz(){
    if(opcaoDeLuz === "luzOn" || opcaoDeLuz == null){
        return
    }
    contadorIntervaloLuz = 10;
    luzDesligada = true;
    console.log("enter desligar luz")
}

$("#enter").click(ligarLuz);
$("#enter").click(desligarLuz);
